...
public class Lab1_Jackson {
    public static void main(String[] args) throws IOException {
        ...
        String applicationJSON = mapper.writeValueAsString(application);
        System.out.println(applicationJSON);
        Application newApplication = mapper.readValue(applicationJSON, Application.class);
